...
export default function Error({
    ...
    return (
        <div className="w-full h-full min-h-[50vh] flex flex-col items-center justify-center p-8 text-center" style={{ background: 'var(--background)' }}>
            <ExclamationTriangleIcon className="w-16 h-16 text-red-500 mb-4" />
            <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--foreground)' }}>Something went wrong!</h2>
            <p className="max-w-md mx-auto mb-6" style={{ color: 'var(--foreground-muted)' }}>
